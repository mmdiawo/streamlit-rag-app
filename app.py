...
def read_txt(file) -> str:
    """Read plain test or markdown file."""
...
def read_html(file) -> str:
    ...
    for element in soup(['script', 'stype', 'nav', 'footer', 'header']):
        element.decompose()
...
def create_faiss_index(embeddings: np.ndarray) -> faiss.IndexFlatL2:
    """Create a FAISS index form embeddings."""
...
def generate_answer(query: str, context_chunks: list[str], api_key: str) -> str:
    ...
    system_prompt = """You are a helpful assistant that answer questions based on the provided context.

Rules:
- Answer ONLY based on the context provided
- IF the context does not contain relevant information, say "I couldn't find relevant information in the documents."
